...
const team = [
    ...
    { name: "kefichik", role: "кичйобмеФирруф", color: "#D1D5DB", textColor: "#171717", img: "/avatarkefichik.png" },
    { name: "OtStrAmPON ", role: "Модератор", color: "#0a0a0a", textColor: "#FFFFFF", img: "/avatarots.gif" },
    { name: "Loomtik", role: "Модератор", color: "#222222", textColor: "#FFFFFF", img: "/avatarloomtik.png" },
    { name: "Tigra", role: "Модератор", color: "#b2a9d9", textColor: "#171717", img: "/avatartigra.png" },
