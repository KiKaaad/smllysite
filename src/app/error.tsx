...
export default function Home() {
    return (
        <main className="min-h-screen bg-[#050505] text-white overflow-x-hidden">
            ...
            <nav className="fixed top-22 w-65 z-5550 right-40 bg-[#111010]/20 backdrop-blur-[16px] rounded-[100px] border border-white/10 h-12 flex items-center justify-center shadow-xl">
                <h6 className="text-center font-medium">500 | Что-то пошло не так...</h6>
            </nav>

            <div className="relative w-full p-20 px-20 flex justify-between">
                <div className="relative z-10 content-center    ">
                    <h1 className="text-[64px] font-bold leading-none mb-4">500, <span className="text-pink-300">это наша проблема</span></h1>
